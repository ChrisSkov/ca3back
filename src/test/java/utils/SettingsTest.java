...
public class SettingsTest {
    ...
    public void testGetDEV_DBConnection(){
        ...
        assertEquals(String.format("jdbc:mysql://167.71.52.90:3306/%s",dbName), Settings.getDEV_DBConnection());
    }
    ...
    public void testGetTEST_DBConnection(){
        ...
        assertEquals(String.format("jdbc:mysql://167.71.52.90:3306/%s",dbName), Settings.getTEST_DBConnection());
    }
